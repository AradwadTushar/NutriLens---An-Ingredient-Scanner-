      ...
      {["Vegetarian", "Vegan", "Keto", "Low Carb", "High Protein", "Gluten-Free"].map((diet) => (
        <button
          ...
          className={`border px-3 py-1 rounded-full ${
            preferences.diet === diet ? "bg-indigo-500 text-white" : "text-gray-600"
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
      {["Dairy-Free", "Nut-Free", "Soy-Free", "Shellfish-Free", "Egg-Free"].map((allergy) => (
        <button
          ...
          type="button"
          className={`border px-3 py-1 rounded-full ${
            preferences.allergies?.includes(allergy) ? "bg-red-500 text-white" : "text-gray-600"
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
      {["Weight Loss", "Muscle Gain", "Maintain Weight", "Diabetic Friendly", "Heart Healthy"].map((goal) => (
        <button
          ...
          type="button"
          className={`border px-3 py-1 rounded-full ${
            preferences.healthGoal === goal ? "bg-green-500 text-white" : "text-gray-600"
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
      {["Artificial Sweeteners", "Preservatives", "High Sugar", "High Salt", "Processed Meat"].map((warn) => (
        <button
          ...
          type="button"
          className={`border px-3 py-1 rounded-full ${
            preferences.warnings?.includes(warn) ? "bg-yellow-500 text-white" : "text-gray-600"
